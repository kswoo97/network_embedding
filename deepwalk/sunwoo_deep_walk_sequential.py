...
class deep_walk() :
    ...
    def backward_prop(self) :
        ...
        # Sequential Update Version : Target arrays are divided into various ways
        # They are updated in sequential way

        for target_v in self.train_y :

            EI = self.y - target_v # V x 1 Shape
            self.EI = EI
